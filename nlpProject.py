...
# )
# # APP TITLE
# st.title("NLP Project PreProcessing APP")
# st.write("Tokenization, Text Cleaning, Stemming, Lemmatization, and Bag of Words")
# # USER INPUT
# text=st.text_area("Enter the text for preprocessing:",height=150,
#                   placeholder="Example : AVENGERS DOOMSDAY IS COMING "
#                   )
# #SIDEBAR OPTIONS
